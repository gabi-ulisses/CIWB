function exercicio5(){
    ...
    console.log("Custam menos que R$10,00: ",produtos.filter(p => p.preco < 10));
    console.log("Não têm desconto no preço à vista: ",produtos.filter(p => p.descontoAVista == null));
